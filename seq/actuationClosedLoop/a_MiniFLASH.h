...
#define ROTOR_LOAD_TORQUE 23
	...
	enum WIPParameterTYPE_OPTION {
		  ...
		  CONSTANTGRD               = 20,
		  SQUAREWAVE                = 30,
		  EXTERNGRD_TRACKACTUATE    = 40,
		  EXTERNGRD_MAXTORQUE       = 50,
		  EXTERNGRD_FB              = 60,
		  EXTERNGRD_PI              = 70,
		  EXTERNGRD_PI_CAPSULE      = 80,
		  EXT_MULTI_ORTHO_ROTORS    = 90,
		  EXT_MULTI_PARALLEL_ROTORS =100,
		  EXTERNGRD_LYAPUNOV_POS    =110,
		  EXTERNGRD_LYAPUNOV_VEL    =120,
	...
	static const char* sOptionType2  = "SquareWave gradients";
    static const char* sOptionType3  = "Constant gradients";
	static const char* sOptionType4  = "Extern Track/Actuate";
	static const char* sOptionType5  = "Extern Max T";
	static const char* sOptionType6  = "Extern FB";
	static const char* sOptionType7  = "Extern PI";
	static const char* sOptionType8  = "Extern capsule";
	static const char* sOptionType9  = "Extern Ortho Rotors";
	static const char* sOptionType10 = "Extern Parallel Rotors";
	static const char* sOptionType11 = "Lyapunov Position";
	static const char* sOptionType12 = "Lyapunov Velocity";
...
protected:
    ...
    sREADOUT         m_sADCXCapusle;
    sFREQ_PHASE      m_sADCX_zSetCapusle;
    sFREQ_PHASE      m_sADCX_zNegCapusle;
    sREADOUT         m_sADCYCapusle;
    sFREQ_PHASE      m_sADCY_zSetCapusle;
    sFREQ_PHASE      m_sADCY_zNegCapusle;
    sREADOUT         m_sADCZCapusle;
    sFREQ_PHASE      m_sADCZ_zSetCapusle;
    sFREQ_PHASE      m_sADCZ_zNegCapusle;
	...
	sGRAD_PULSE	     m_InitPulseX[MAX_NB_EXTERN_STEP];
	sGRAD_PULSE	     m_InitPulseY[MAX_NB_EXTERN_STEP];
	sGRAD_PULSE	     m_InitPulseZ[MAX_NB_EXTERN_STEP];
...
private:
	...
	// 
	// * ------------------------------------------------------------------ *
    // * Apply a new rotation matrix based on custom UI                     *
    // * ------------------------------------------------------------------ *
    void applyRotMatrix(int32_t axis);
    void applyRotMatrix(double angle);

	void prepareComADC(MrProt &rMrProt);
	NLS_STATUS prepareSinusoidalPulse(MrProt &rMrProt);
	NLS_STATUS prepareExternalPulse(MrProt &rMrProt, long gradDuration);
	NLS_STATUS prepareInitPulse(MrProt &rMrProt);

	NLS_STATUS sendComDataToIce(sREADOUT &adc, sFREQ_PHASE &adcSet, sFREQ_PHASE &adcNeg, int index);
	
	NLS_STATUS applySETracking                    (MrProt &rMrProt, long& lT, long lLine);
	NLS_STATUS applySETracking3Axis               (MrProt &rMrProt, long& lT, long lLine);
	NLS_STATUS applySETrackingActuation           (MrProt &rMrProt, long& lT, long lLine);
	NLS_STATUS applyGRETracking                   (MrProt &rMrProt, long& lT, long lLine);
	NLS_STATUS applySinusoidalActuation           (MrProt &rMrProt, long& lT, long lLine);
	NLS_STATUS applyConstantActuation             (MrProt &rMrProt, long& lT, long lLine);
	NLS_STATUS applyExternActuation               (MrProt &rMrProt, long& lT, long lLine);
	NLS_STATUS applySquareWaveActuation           (MrProt &rMrProt, long& lT, long lLine);
	NLS_STATUS applyInitPulse                     (MrProt &rMrProt, long& lT, long lLine);
	NLS_STATUS applySEImagingForCapsules          (MrProt &rMrProt, long& lT, long lLine);
	NLS_STATUS applySETrackingActuationForCapsules(MrProt &rMrProt, long& lT, long lLine);
	NLS_STATUS applyActiveMarkerSEImaging         (MrProt &rMrProt, long& lT, long lLine);
