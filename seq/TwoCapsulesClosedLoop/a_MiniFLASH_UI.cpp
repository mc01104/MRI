...
using namespace WPT_NAMESPACE;
	...
	void MiniFlashUI::createWIPParameters (SeqLim &rSeqLim, WIPParameterTool& rTool)
	{
		...
		rTool.createDoubleParameter(WIPDoubleK1, rSeqLim, "delay", "ms", 8, -10000., 10000., .1, 2);
		rTool.createDoubleParameter(WIPDoubleK2, rSeqLim, "Rf duration", "us", 2, 0, 20000, 1, 2);
