...
private:
	...
	double m_roadMaps[12]; // Array containing angle of projections 
	                       // defining the path of the bead
	uint16_t m_wayPoints[12]; // Array containing waypoints 
	                       // defining targets of the bead

	double m_prjAngle;
	// Capsules variables
	uint8_t m_nbSegments;
	...
	NLS_STATUS applySETrackingActuationForMultiCapsules(MrProt &rMrProt, long& lT, long lLine);
	NLS_STATUS pause1Sec                          (MrProt &rMrProt, long& lT, long lLine);
	NLS_STATUS applyActiveMarkerGREImaging        (MrProt &rMrProt, long& lT, long lLine);
