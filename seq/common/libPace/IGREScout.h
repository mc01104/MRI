...
//
//          Project: NUMARIS/4
//             File: \n4_servers1\pkg\MrServers\MrImaging\seq\common\libPace\IGREScout.h
//          Version: \main\13
//
//         Language: C++
//
//      Description: Definition of interface class IGREScout
//          Structs: 
//
//  -----------------------------------------------------------------
...
#ifndef __IGRESCOUT_H
#define __IGRESCOUT_H
...
namespace PACE
{
    ...
    struct GRESCOUT_PARA
    {
        ...
        //  Number of pahse encoding lines
        int32_t    m_i32NPELin;
    ...
    //  Definition of class IGREScout
    //  -----------------------------------------------------------------    
    class IGREScout : public IScout
    {
    public:
        //  Creates object of type SBBScoutScan
        static IGREScout* create();

        typedef GRESCOUT_PARA PARA;
...
#ifdef _VB_LINE
        static NLS_STATUS init(sRF_PULSE_SINC*&       rpRfPulse_alpha, TArray<double>& radFlipAngle_alpha_deg, PARA* pPara, MrProt*       pProt, SeqLim* pSeqLim, SeqExpo*                 pSeqExpo, uint32_t u32NavPos, const char* pszIdent_alpha);
#else
        static NLS_STATUS init(MrPtr<IRF_PULSE_SINC>& rpRfPulse_alpha, TArray<double>& radFlipAngle_alpha_deg, PARA* pPara, const MrProt* pProt, SeqLim* pSeqLim, MrProtocolData::SeqExpo* pSeqExpo, uint32_t u32NavPos, const char* pszIdent_alpha);
#endif
