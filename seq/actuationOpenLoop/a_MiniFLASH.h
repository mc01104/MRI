...
//
//     Project: NUMARIS/4
//        File: \n4_servers1\pkg\MrServers\MrImaging\seq\actuationOpenLoop\a_MiniFLASH.h
//     Version: \main\9
//      Author: Clinical
...
namespace SEQ_NAMESPACE
{
	...
	enum WIPParameterPositions {
		WIPSelectionGradDir1,
		WIPDoubleGradAmpl1,
		WIPDoubleGradDur1,
		WIPSelectionGradDir2,
		WIPDoubleGradAmpl2,
		WIPDoubleGradDur2,
		WIPSelectionGradDir3,
		WIPDoubleGradAmpl3,
		WIPDoubleGradDur3,
		WIPSelectionGradDir4,
		WIPDoubleGradAmpl4,
		WIPDoubleGradDur4,
    };

	enum WIPParameterDir {
		  X_DIR            = 10,
		  Z_DIR            = 20
	};
...
protected:
 ...
 //   int32_t m_lLinesToMeasure;
	...
	int				 m_nbGrad;
	sGRAD_PULSE      m_sGPropulsion1, m_sGPropulsion2, m_sGPropulsion3, m_sGPropulsion4;
	
	double			 m_gradAngleTable[4];
